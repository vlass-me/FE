...
axios.defaults.headers['Access-Control-Allow-Origin'] = 'https://vlass.limdongjin.com';
// axios.defaults.headers["Access-Control-Allow-Credentials"] = 'true';
class SttService {
  saveSession: (userId: string, sessionId) => Promise<AxiosResponse<any>> = async (userId: string, sessionId: string) => {
    const apiURL = `${IGNASR_SERVER}/api/speech/saveSession`
